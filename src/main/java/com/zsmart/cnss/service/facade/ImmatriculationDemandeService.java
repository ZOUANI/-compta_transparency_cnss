...
public ImmatriculationDemande  saveWithSalarieImmatriculations (ImmatriculationDemande immatriculationdemande);public List<ImmatriculationDemande>  findAll();
