...
public AffiliationDemande  saveWithLieuActivites (AffiliationDemande affiliationdemande);public AffiliationDemande  saveWithSalarieAffiliations (AffiliationDemande affiliationdemande);public List<AffiliationDemande>  findAll();
