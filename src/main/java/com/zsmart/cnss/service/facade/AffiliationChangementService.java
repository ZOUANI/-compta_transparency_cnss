...
public AffiliationChangement  saveWithObjetChangementAffiliations (AffiliationChangement affiliationchangement);public AffiliationChangement  saveWithPiecesDemandeChangements (AffiliationChangement affiliationchangement);public List<AffiliationChangement>  findAll();
