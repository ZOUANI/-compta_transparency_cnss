...
if(piecesobjetchangement== null){       return null ;
}else{PiecesObjetChangement piecesobjetchangementClone= new PiecesObjetChangement();
...
if(piecesobjetchangements== null){
       return null ;
}else{List<PiecesObjetChangement> piecesobjetchangementsClone = new ArrayList();
	 	 	 piecesobjetchangements.forEach((piecesobjetchangement)->{piecesobjetchangementsClone.add(clone(piecesobjetchangement));
