...
if(affiliationchangementetat== null){       return null ;
}else{AffiliationChangementEtat affiliationchangementetatClone= new AffiliationChangementEtat();
...
if(affiliationchangementetats== null){
       return null ;
}else{List<AffiliationChangementEtat> affiliationchangementetatsClone = new ArrayList();
	 	 	 affiliationchangementetats.forEach((affiliationchangementetat)->{affiliationchangementetatsClone.add(clone(affiliationchangementetat));
