...
if(objetchangement== null){       return null ;
}else{ObjetChangement objetchangementClone= new ObjetChangement();
...
if(objetchangements== null){
       return null ;
}else{List<ObjetChangement> objetchangementsClone = new ArrayList();
	 	 	 objetchangements.forEach((objetchangement)->{objetchangementsClone.add(clone(objetchangement));
