...
if(immatriculationdemandeetat== null){       return null ;
}else{ImmatriculationDemandeEtat immatriculationdemandeetatClone= new ImmatriculationDemandeEtat();
...
if(immatriculationdemandeetats== null){
       return null ;
}else{List<ImmatriculationDemandeEtat> immatriculationdemandeetatsClone = new ArrayList();
	 	 	 immatriculationdemandeetats.forEach((immatriculationdemandeetat)->{immatriculationdemandeetatsClone.add(clone(immatriculationdemandeetat));
