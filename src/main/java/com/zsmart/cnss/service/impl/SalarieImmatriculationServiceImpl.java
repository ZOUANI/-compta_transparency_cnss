...
if(salarieimmatriculation== null){       return null ;
}else{SalarieImmatriculation salarieimmatriculationClone= new SalarieImmatriculation();
...
if(salarieimmatriculations== null){
       return null ;
}else{List<SalarieImmatriculation> salarieimmatriculationsClone = new ArrayList();
	 	 	 salarieimmatriculations.forEach((salarieimmatriculation)->{salarieimmatriculationsClone.add(clone(salarieimmatriculation));
