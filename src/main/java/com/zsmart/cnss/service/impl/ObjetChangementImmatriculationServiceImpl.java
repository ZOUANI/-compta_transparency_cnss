...
if(objetchangementimmatriculation== null){       return null ;
}else{ObjetChangementImmatriculation objetchangementimmatriculationClone= new ObjetChangementImmatriculation();
...
if(objetchangementimmatriculations== null){
       return null ;
}else{List<ObjetChangementImmatriculation> objetchangementimmatriculationsClone = new ArrayList();
	 	 	 objetchangementimmatriculations.forEach((objetchangementimmatriculation)->{objetchangementimmatriculationsClone.add(clone(objetchangementimmatriculation));
