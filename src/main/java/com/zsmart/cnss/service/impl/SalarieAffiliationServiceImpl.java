...
if(salarieaffiliation== null){       return null ;
}else{SalarieAffiliation salarieaffiliationClone= new SalarieAffiliation();
...
if(salarieaffiliations== null){
       return null ;
}else{List<SalarieAffiliation> salarieaffiliationsClone = new ArrayList();
	 	 	 salarieaffiliations.forEach((salarieaffiliation)->{salarieaffiliationsClone.add(clone(salarieaffiliation));
