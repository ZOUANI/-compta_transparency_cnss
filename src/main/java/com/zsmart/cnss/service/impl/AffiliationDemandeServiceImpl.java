...
if(affiliationdemande== null){       return null ;
}else{AffiliationDemande affiliationdemandeClone= new AffiliationDemande();
...
if(affiliationdemandes== null){
       return null ;
}else{List<AffiliationDemande> affiliationdemandesClone = new ArrayList();
	 	 	 affiliationdemandes.forEach((affiliationdemande)->{affiliationdemandesClone.add(clone(affiliationdemande));
