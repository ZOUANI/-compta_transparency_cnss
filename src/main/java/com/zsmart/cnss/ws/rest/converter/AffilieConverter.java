...
private boolean declarationSalaries; 
...
Affilie item = new Affilie();
 ...
 if (ListUtil.isNotEmpty(vo.getDeclarationSalariesVo ()) && declarationSalaries) {
 item.setDeclarationSalaries(declarationSalarieConverter.toItem(vo.getDeclarationSalariesVo())); 
} 
...
AffilieVo vo = new AffilieVo();
 ...
 if(ListUtil.isNotEmpty(item.getDeclarationSalaries()) && declarationSalaries) {
 vo.setDeclarationSalariesVo(declarationSalarieConverter.toVo(item.getDeclarationSalaries()));
} 
